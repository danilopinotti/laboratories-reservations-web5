...
class ReservesControllerTest < ActionController::TestCase
  ...
  test "should create reserf" do
    assert_difference('Reserve.count') do
      post :create, reserf: { begin_at_id: @reserf.begin_at_id, day: @reserf.day, end_at_id: @reserf.end_at_id, laboratory_id: @reserf.laboratory_id, user_id: @reserf.user_id }
    end
  ...
  test "should update reserf" do
    patch :update, id: @reserf, reserf: { begin_at_id: @reserf.begin_at_id, day: @reserf.day, end_at_id: @reserf.end_at_id, laboratory_id: @reserf.laboratory_id, user_id: @reserf.user_id }
    assert_redirected_to reserf_path(assigns(:reserf))
  end
